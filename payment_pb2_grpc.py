...
class PaymentServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.VerifyTransaction = channel.unary_unary(
                '/payment.PaymentService/VerifyTransaction',
                request_serializer=payment__pb2.VerifyRequest.SerializeToString,
                response_deserializer=payment__pb2.VerifyResponse.FromString,
                _registered_method=True)
        self.ProcessFuelPayment = channel.unary_unary(
                '/payment.PaymentService/ProcessFuelPayment',
                request_serializer=payment__pb2.FuelPaymentRequest.SerializeToString,
                response_deserializer=payment__pb2.FuelPaymentResponse.FromString,
                _registered_method=True)
...
def add_PaymentServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'VerifyTransaction': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=payment__pb2.VerifyRequest.FromString,
                    response_serializer=payment__pb2.VerifyResponse.SerializeToString,
            ),
            'ProcessFuelPayment': grpc.unary_unary_rpc_method_handler(
                    servicer.ProcessFuelPayment,
                    request_deserializer=payment__pb2.FuelPaymentRequest.FromString,
                    response_serializer=payment__pb2.FuelPaymentResponse.SerializeToString,
            ),
    }
...
class PaymentService(object):
    ...
    def VerifyTransaction(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/payment.PaymentService/VerifyTransaction',
            payment__pb2.VerifyRequest.SerializeToString,
            payment__pb2.VerifyResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    @staticmethod
    def ProcessFuelPayment(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/payment.PaymentService/ProcessFuelPayment',
            payment__pb2.FuelPaymentRequest.SerializeToString,
            payment__pb2.FuelPaymentResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
