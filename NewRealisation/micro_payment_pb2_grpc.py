...
import micro_payment_pb2 as micro__payment__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in micro_payment_pb2_grpc.py depends on'
...
class MicroPaymentServiceStub(object):
...
class MicroPaymentServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_MicroPaymentServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'micro.MicroPaymentService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('micro.MicroPaymentService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class MicroPaymentService(object):
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def StreamPayments(request_iterator,
            target,
            options=(),
